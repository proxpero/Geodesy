#
#  Be sure to run `pod spec lint Geodesy.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Todd Olsen" => "todd.olsen@me.com" }
  # Or just: s.author    = "Todd Olsen"
  # s.authors            = { "Todd Olsen" => "todd.olsen@me.com" }
